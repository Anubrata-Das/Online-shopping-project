...
%>
        ...
        <tbody>
 <%
      ResultSet rs=st.executeQuery("select * from product inner join cart on product.id=cart.product_id and cart.email='"+email+"'");
      while(rs.next())
      {
      %>
          <tr>
...
<hr style="width: 100%">
<form action="addressPayemtForOrderAction.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
